...
public class PanelTempoUnidade extends JPanel {
	...
	public PanelTempoUnidade(Color cor, Unidade unidade) {
		...
		// Define a velocidade real de cada unidade. Multiplica por 60 porque o
		// tempo das unidades
		// é em minutos, não em segundos.

		velocidadeReal = unidade
				.velocidade()
				.divide(Mundo_Reader.MundoSelecionado.getVelocidade(), 30,
						BigDecimal.ROUND_HALF_EVEN)
				.divide(Mundo_Reader.MundoSelecionado.getModificarUnidaes(),
						30, BigDecimal.ROUND_HALF_EVEN)
	...
	protected void setTempo(BigDecimal distância) {
		...
		if (distância == null)
			...
			BigDecimal time = velocidadeReal.multiply(distância).setScale(0,
