...
public class PanelAldeia extends JPanel {
	 ...
	 * 
	 * @param nome Nome da Aldeia (origem ou destino)
	 * @param gui
	 */
	...
	public void addPanelCoordenadas(GridBagConstraints c) {
		...
		coordenadas.setBorder(new MatteBorder(1, 0, 0, 0, Cores.SEPARAR_ESCURO));
	...
	protected int getCoordenadaX() { return Integer.parseInt(x.getText()); }
	protected int getCoordenadaY() { return Integer.parseInt(y.getText()); }
