 ...
 */
public class WorldInfo implements EditableObject {
     ...
     */
    public WorldInfo(JSONObject json) {
        this.json = json;
    }
    ...
    public WorldInfo setMilitiaWorld(boolean boo) {
    	this.set("militia", boo);
    	return this;
    }
    
    public WorldInfo setArcherWorld(boolean boo) {
        this.set("archer", boo);
        return this;
    }

    public WorldInfo setPaladinWorld(boolean boo) {
        this.set("paladin", boo);
        return this;
    }

    public WorldInfo setChurchWorld(boolean boo) {
        this.set("church", boo);
        return this;
    }

    public WorldInfo setMoralWorld(boolean boo) {
        this.set("moral", boo);
        return this;
    }

    public WorldInfo setFlagWorld(boolean boo) {
        this.set("flag", boo);
        return this;
    }

    // MADI BOO
    public WorldInfo setNightBonusWorld(boolean boo) {
        this.set("nightbonus", boo);
        return this;
    }

    public WorldInfo setBetterItemsWorld(boolean boo) {
        this.set("betteritems", boo);
        return this;
    }

    public WorldInfo setCoiningWorld(boolean boo) {
        this.set("coining", boo);
        return this;
    }

    public WorldInfo setWorldSpeed(double speed) {
        this.set("speed", speed);
        return this;
    }

    public WorldInfo setUnitModifier(double unitModifier) {
        this.set("unit_modifier", unitModifier);
        return this;
    }

    public WorldInfo setResearchSystem(ResearchSystem ss) {
