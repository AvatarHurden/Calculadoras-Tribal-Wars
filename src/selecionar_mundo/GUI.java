...
public class GUI extends JFrame{
	...
	private void addImage(GridBagConstraints c) {
		...
		lblTítulo.setIcon(new ImageIcon
	...
	/**
	 * Cria um JPanel com a tabela de informações do mundo, lista de mundos e botão para iniciar
	...
	/**
	 * Muda as informações da tabela, chamado toda vez que o mundo selecionado é alterado
	 */
