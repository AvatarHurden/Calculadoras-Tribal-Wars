...
public class Informações_de_mundo extends JPanel {
	...
	/**
	 * Muda as informações da tabela
	 * A lista de propriedades inserida não é exatamente igual à que será mostrada, pois
	 * ocorrem adaptações para facilitar a visualização
	 * 
	 * @param prop Propriedades básicas
	 */
