...
public class BigOperation {
	...
	/**
	 * Formats <code>number</code> to have, at most,
	 * <code>digitsToDisplay</code> digits.
	 * 
	 * Useful to reduce the precision of the <code>BigDecimal</code> or to
	 * display the number on a GUI. Uses <code>BigDecimal.ROUND_HALF_EVEN</code>
	 * as a rounding mode.
	 * 
	 * @param number
	 *            <code>BigDecimal</code> to be formated
	 * @param digits
	 *            number of digits the new <code>BigDecimal</code> will have
	...
	public static BigDecimal format(BigDecimal number, int digits) {
		...
		try {
			...
			number = number.setScale(decimalsDisplayed,
	 ...
	 * 
	 * @param n1
	 *            <code>BigDecimal</code> to be raised
	 * @param n2
	 *            <code>BigDecimal</code> power
	...
	public static BigDecimal pow(BigDecimal n1, BigDecimal n2) {
		...
		// Fix negative power
		if (signOf2 == -1)
			result = BigDecimal.ONE.divide(result, 30,
					BigDecimal.ROUND_HALF_EVEN);
