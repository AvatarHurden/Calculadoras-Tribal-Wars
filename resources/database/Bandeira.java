...
public class Bandeira {
	...
	public double getValue() {
		...
		// A bandeira de sorte é muito confusa, pois não possui um crescimento contínuo nos últimos níveis
	...
	// Categorias diferentes que cada bandeira pode ter. Cada uma possui seu valor base e
	// aumento por nível, além de um "tipo" criado por mim para facilitar funcionamento
	...
	public enum CategoriaBandeira {
		...
		private CategoriaBandeira (Tipo tipo, String frase, int inicial, int aumento) {
		...
		public String toString(int nível) {
			...
			if (this == NULL) {
				...
				if (nível == 8)
					...
					return "Equilibra a sorte em "+(inicial+nível*aumento)+"%";
