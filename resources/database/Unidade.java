...
public enum Unidade {
	...
	LANCEIRO("Lanceiro", Type.Geral, 50, 30, 10, 1, 10, 15, 45, 20, 18, 25, 680), ESPADACHIM(
			"Espadachim", Type.Geral, 30, 30, 70, 1, 25, 50, 15, 40, 22, 15,
			1000), BÁRBARO("Bárbaro", Type.Geral, 60, 30, 40, 1, 40, 10, 5, 10,
			18, 10, 880), ARQUEIRO("Arqueiro", Type.Arqueiro, 100, 30, 60, 1,
			15, 50, 40, 5, 18, 10, 1200), EXPLORADOR("Explorador",
			Type.unspecified, 50, 50, 20, 2, 0, 2, 1, 2, 9, 0, 600), CAVALOLEVE(
			"Cavalaria Leve", Type.Cavalo, 125, 100, 250, 4, 130, 30, 40, 30,
			10, 80, 1200), ARCOCAVALO("Arqueiro a Cavalo", Type.Arqueiro, 250,
			100, 150, 5, 120, 40, 30, 50, 10, 50, 1800), CAVALOPESADO(
			"Cavalaria Pesada", Type.Cavalo, 200, 150, 600, 6, 150, 200, 80,
			180, 11, 50, 2400), ARÍETE("Aríete", Type.Geral, 300, 200, 200, 5,
			2, 20, 50, 20, 30, 0, 3200), CATAPULTA("Catapulta", Type.Geral,
			320, 400, 100, 8, 100, 100, 50, 100, 30, 0, 4800), PALADINO(
			"Paladino", Type.Cavalo, 20, 20, 40, 10, 150, 250, 400, 150, 10,
			100, 21600), NOBRE("Nobre", Type.Geral, 40000, 50000, 50000, 100,
			30, 100, 50, 100, 35, 0, 12000), MILÍCIA("Milícia",
			Type.unspecified, 0, 0, 0, 0, 0, 15, 45, 25, 0.02, 0, 0);
